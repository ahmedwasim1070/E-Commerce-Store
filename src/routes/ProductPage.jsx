...
import {productData,countryCity,cartData} from '../data/Data';
            ...
            <div onClick={smNav} className='w-full h-[85vh] absolute top-[120px] flex justify-end backdrop-blur-sm overflow-y-hidden'>
              <div onClick={smNavClick} className='w-[50%] h-full bg-white border border-solid rounded-lg slide-in'>
                <ul className='w-full h-full text-black text-center text-[1rem] mt-8 flex flex-col  items-center'>
                  ...
                  <Link to='/'><li className='py-5 underline-animation-sm'>About Us</li></Link>
                </ul>
              </div>
            </div> 
          :
      ...
      <form ref={formRef} className='border border-[rgba(255,255,255,0.2)] p-10 rounded-2xl flex flex-col gap-10'>
        ...
        <div className='flex items-center gap-5 flex-wrap'>
          ...
          <div className='flex items-center'>
            <button name='neg' onClick={setVal} type='button' className='px-3 border border-solid text-[1.1rem] hover:bg-white hover:text-black '>-</button>
            <input value={inputValue} min='1' className='w-[40px] bg-transparent border border-solid text-white outline-none px-3 text-[1.1rem] cursor-default' required  readOnly/>
            <button name='pos' onClick={setVal} type='button' className='px-3 border border-solid text-[1.1rem]  hover:bg-white hover:text-black '>+</button>
          </div>
        </div>
