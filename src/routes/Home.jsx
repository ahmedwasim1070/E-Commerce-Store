...
function Hero({idxPr,setIdxPr,addToCart}){
  ...
  return(
    <section className={`w-full 2xl:h-[850px] xl:h-[800px] lg:h-[750px] md:h-[700px] sm:h-[850px] flex justify-evenly md:relative sm:relative esm:relative esm:h-[900px] ${fade} text-white ${productData[idxPr].productBg}`}>
      ...
      <div className='h-full flex flex-col justify-center ml-20 2xl:relative 2xl:left-0 2xl:top-0 2xl:w-[40%] xl:relative xl:left-0 xl:top-0 xl:w-[40%] lg:relative lg:left-0 lg:top-0 lg:w-[40%] md:absolute md:left-[2%] md:top-[0%] md:w-[40%] sm:absolute sm:left-[1%] sm:top-[0%] sm:w-[40%] esm:absolute esm:left-[-50px] esm:top-[3%] esm:w-[250px]'>
        <div className='mb-10'>
        ...
        <div className='w-full ml-5'>
          <button onClick={()=>addToCart(idxPr)} className='flex gap-2 border border-solid items-center mb-5 rounded-full bg-transparent font-bold  trnasition-all duration-300 outline-none  hover:bg-black 2xl:p-4 2xl:mt-10 xl:p-2 xl:mx-5 xl:mt-0 lg:p-2 lg:mt-0 lg:mx-2 md:p-3 md:mx-0 md:mt-5 sm:p-2 sm:mt-2 sm:mx-0 esm:mt-[250px] esm:p-2'>
